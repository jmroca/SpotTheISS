...
+ (UIToolbar*) createKeyboardAccesoryToolBarInViewController:(UIViewController*) vc
{
    
    UIToolbar* numberToolbar = [[UIToolbar alloc]initWithFrame:CGRectMake(0, 0, 320, 50)];
    UISegmentedControl *segmentControl = [[UISegmentedControl alloc] initWithItems:[NSArray arrayWithObjects:NSLocalizedString(@"PREVIOUS", nil), NSLocalizedString(@"NEXT", nil), nil]]; [segmentControl setSegmentedControlStyle:UISegmentedControlStyleBar]; [segmentControl addTarget:vc action:@selector(nextPrevious:) forControlEvents:UIControlEventValueChanged];
    ...
    numberToolbar.items = [NSArray arrayWithObjects:
                           [[UIBarButtonItem alloc] initWithCustomView:segmentControl],
                           
                           [[UIBarButtonItem alloc]initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:nil action:nil],
                           [[UIBarButtonItem alloc]initWithTitle:@"Done" style:UIBarButtonItemStyleDone target:vc action:@selector(doneWithKeyboard)],
                           nil];
